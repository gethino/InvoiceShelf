...
/**
 * Bridges the Money context to documents that have not yet exposed their own
 * exchange-rate write contracts. Delete this adapter as those contexts move.
 */
class LegacyExchangeRateBackfill implements ExchangeRateBackfill
{
